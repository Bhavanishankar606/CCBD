...
public class EnhancedDatacenterCharacteristics {	/** The resource id -- setup when Resource is created. */
	private int id;
	...
	public int getMips() {
		...
		// Assuming all PEs in all Machine have same rating.
			case EnhancedDatacenterCharacteristics.TIME_SHARED:
			case EnhancedDatacenterCharacteristics.OTHER_POLICY_SAME_RATING:
			...
			case EnhancedDatacenterCharacteristics.SPACE_SHARED:
			case EnhancedDatacenterCharacteristics.OTHER_POLICY_DIFFERENT_RATING:
